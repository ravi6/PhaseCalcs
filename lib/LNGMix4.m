function LNGComps = LNGMix4(intOFF)
...
k = zeros(Nc, Nc);
k(CH4, CH4) = 0 ; k(CH4, C2H6) = -0.0026; k(CH4, C3H8) = 0.014; k(CH4, N2) = 0.0311;
k(CH4, iC4H10) = 0.0256; k(CH4, C4H10) =  0.0133; k(CH4, iC5H12) = 0.0230;

k(C2H6, C2H6) = 0 ; k(C2H6, C3H8) = 0.0011; k(C2H6, N2) = 0.0515;
k(C2H6, iC4H10) = -0.0067; k(C2H6, C4H10) =  0.0096; k(C2H6, iC5H12) = 0.0 ;

K(C3H8, C3H8) = 0 ; k(C3H8, N2) = 0.0852; k(C3H8, iC4H10) = -0.0078; 
k(C3H8, C4H10) = 0 ; k(C3H8, iC5H12) = 0.0111;
